...
//KDC2 : FixIntraRd function to just initialize the rdcosts to 0 and no need to compute it(use for skipping)
void Search::FixIntraRd(Mode& intraMode, const CUGeom& cuGeom, PartSize partSize)
{
    CUData& cu = intraMode.cu;
