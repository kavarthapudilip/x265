...
public:
	...
	//KDC2 : add the array for start depths
	//uint8_t*	  m_mrStartRefDepth;  // array of multi-rate start reference depths
	...
	//KDC2 : function to get start ref depths
	//uint8_t* getMRStartRefDepth() { return m_mrStartRefDepth; }
